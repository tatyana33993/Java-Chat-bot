...
public class TownsGameMemory 
{
	...
	public TownsGameMetaMemory GetMetaInfo()
	{
		return metaInfo;
	}
	...
	public boolean CheckTownInUnused(String town)
	{
		...
		{
			if (unusedTowns[i].equalsIgnoreCase(town))
				return true;
		}
		return false;
	}
